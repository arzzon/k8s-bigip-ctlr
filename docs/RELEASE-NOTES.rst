...
**What's new:**
    ...
    * CRD
        * `Issue 3374 <https://github.com/F5Networks/k8s-bigip-ctlr/issues/3374>`_: RFE: Target discrete Pool_Member entities with ConfigMap. See `Documentation <./config_examples/configmap/user-defined-configmap/README.md#cisf5comas3-pool-member-prioritygroup-label>`_
        ...
        * `Issue 3559 <https://github.com/F5Networks/k8s-bigip-ctlr/issues/3559>`_: Support for CIS to watch Custom Resources with custom label. See `Example <./config_examples/customResource/CustomResource.md#label>`_
...
Manifest Files
````````````````
- `CRD <https://github.com/F5Networks/k8s-bigip-ctlr/blob/master/docs/config_examples/customResourceDefinitions/customresourcedefinitions.yml>`_
- `RBAC <https://github.com/F5Networks/k8s-bigip-ctlr/tree/master/docs/config_examples/rbac>`_
